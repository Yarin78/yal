...
/**
 * Construct a suffix array in O(n)
 ...
 *
 * For a slower, but shorter, implementation, see SuffixArrayBuilder
 */
public class SuffixArray {
  ...
  public int[] buildSuffixArray() {
    int SA[] = new int[N + 3];
    makeSuffixArray(s, SA, N, 512);
    sa = Arrays.copyOf(SA, N);
    return sa;
  }
  ...
  private void computeS0(int[] s, int[] s0, int[] SA0, int[] SA12,
  ...
  private  boolean suffix12IsSmaller(int[] s, int[] s12, int[] SA12, int n0, int i, int j, int t) {
